...
function Akilzon:OnCombatStart(delay)
	...
	self:StartStatusBarTimer(40 - delay, "Electrical Storm", "Interface\\Icons\\Spell_Lightning_LightningBolt01")
	self:ScheduleAnnounce(35 - delay, DBM_AKIL_WARN_STORM_SOON, 1)
...
function Akilzon:OnSync(msg)
	if msg:sub(0, 5) == "Storm" then
		...
		self:SetIcon(msg, 10)
		self:StartStatusBarTimer(40, "Electrical Storm", "Interface\\Icons\\Spell_Lightning_LightningBolt01")
		self:ScheduleAnnounce(35, DBM_AKIL_WARN_STORM_SOON, 1)
