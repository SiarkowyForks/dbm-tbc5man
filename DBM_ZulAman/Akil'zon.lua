...
function Akilzon:OnCombatStart()
	...
	self:StartStatusBarTimer(39, "Electrical Storm", "Interface\\Icons\\Spell_Lightning_LightningBolt01")
	self:ScheduleAnnounce(34, DBM_AKIL_WARN_STORM_SOON, 1)
...
function Akilzon:OnSync(msg)
	if msg:sub(0, 5) == "Storm" then
		...
		self:SetIcon(msg, 10)
		self:StartStatusBarTimer(41, "Electrical Storm", "Interface\\Icons\\Spell_Lightning_LightningBolt01")
		self:ScheduleAnnounce(36, DBM_AKIL_WARN_STORM_SOON, 1)
