...
DBM_PW_YELL_1 			= "Лоскутик want to play!";
DBM_PW_YELL_2 			= "Kel'thuzad make Patchwerk his avatar of war!";

DBM_PW_HS_YOU_HIT		= "Лоскутик's Hateful Strike hits you for (%d+).(.*)";
DBM_PW_HS_YOU_MISS		= "Лоскутик's Hateful Strike misses you.";
...
DBM_PWSTATS_STATS		= "*** Лоскутик Stats ***";
...
DBM_PWSTATS_MISSES		= "Промахи: %s (%.0f%%)";
DBM_PWSTATS_AVG_DMG		= "Average damage per hit: %.0f";
DBM_PWSTATS_MAX_HIT		= "Максимальный хит: %s on %s";
DBM_PWSTATS_PER_PLAYER		= "%s Hateful Strikes on >%s< (%s hits)";
DBM_PWSTATS_NOT_AVAILABLE	= "Статы недоступны";


--Grobbulus
DBM_GROBB_NAME				= "Гроббулус";
...
DBM_GROBB_CLOUD_POISON			= "Гроббулус casts Poison Cloud.";
...
--Razuvious
DBM_IR_NAME				= "Инструктор Разувиус";
...
DBM_NTP_BACK_WARNING			= "*** Noth is back (for %s sec) ***";
...
DBM_NTP_SPELL_1 			= "Нот Чумной gains Blink.";
...
--Heigan the Unclean
DBM_HTU_NAME			= "Хейган Нечистивый";
DBM_HTU_DESCRIPTION		= "Provides a timer for Heigan's Teleport.";

DBM_HTU_TELEPORT_WARNING	= "*** Телепорт через %s секунд ***";
DBM_HTU_TELEPORT_BACK_WARNING	= "*** Телепорт обратно через %s секунд ***";

DBM_HTU_YELL_START1 		= "Ты... Следующий.";
DBM_HTU_YELL_START2 		= "Я тебя вижу...";
DBM_HTU_YELL_START3 		= "Ты сейчас мой.";

DBM_SBT["Teleport"]		= "Телепорт";
DBM_SBT["Teleport Back"]	= "Телепорт обратно";


--Anub'Rekhan
DBM_AR_NAME			= "Ануб'Рекан";
...
DBM_GWF_NAME			= "Великая вдова Фарлина";
...
-- FourHorsemen
DBM_FOURHORSEMEN_NAME				= "Четыре Всадника";
...
DBM_FOURHORSEMEN_THANE				= "Тан Кортазз";
DBM_FOURHORSEMEN_LADY				= "Леди Бломе";
DBM_FOURHORSEMEN_MOGRAINE			= "Верховный лорд Могрейн";
DBM_FOURHORSEMEN_ZELIEK			= "Сэр Зелиек";

DBM_FOURHORSEMEN_REAL_NAME			= "Четыре Всадника";
...
DBM_FOURHORSEMEN_INFOFRAME_TITLE		= "Четыре Всадника";
DBM_FOURHORSEMEN_INFOFRAME_TEXT		= "Shows HP of the Horsemen";

DBM_FOURHORSEMEN_MARK_EXPR			= "afflicted by Mark of"; 
DBM_FOURHORSEMEN_MARK_ANNOUNCE			= "*** Mark #%d ***";
DBM_FOURHORSEMEN_MARK_WARNING			= "*** Mark #%d in 5 sec ***";

DBM_FOURHORSEMEN_METEOR_EXPR			= "Тан Кортазз's Meteor hits ([^%s]+) for (%d+) Fire damage%.";
DBM_FOURHORSEMEN_METEOR_ANNOUNCE		= "*** Meteor ***";

DBM_FOURHORSEMEN_VOID_EXPR			= "Леди Бломе casts Void Zone.";
...
DBM_THADDIUS_CAST_POL			= "Таддиус begins to cast Polarity Shift.";
...
DBM_THADDIUS_INFOFRAME_TITLE	= "Таддиус";
...
--DBM_KELTHUZAD_MC_EXPR3		= "%sїсР¦І»Ц№";			 --laugh emote
...
DBM_KELTHUZAD_FISSURE_EXPR		= "Кел'Тузад casts Shadow Fissure.";
